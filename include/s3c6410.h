...
#define ELFIN_GPA_BASE      0x7f008000
#define ELFIN_GPB_BASE      0x7f008020
#define ELFIN_GPC_BASE      0x7f008040
#define ELFIN_GPD_BASE      0x7f008060
#define ELFIN_GPE_BASE      0x7f008080
#define ELFIN_GPF_BASE      0x7f0080A0
#define ELFIN_GPG_BASE      0x7f0080C0
#define ELFIN_GPH_BASE      0x7f0080E0
#define ELFIN_GPI_BASE      0x7f008100
#define ELFIN_GPJ_BASE      0x7f008120

#define ELFIN_GPO_BASE      0x7f008140
#define ELFIN_GPP_BASE      0x7f008160
#define ELFIN_GPQ_BASE      0x7f008180

#define ELFIN_GPK_BASE      0x7f008800
#define ELFIN_GPL_BASE      0x7f008810
#define ELFIN_GPM_BASE      0x7f008820
#define ELFIN_GPN_BASE      0x7f008830

#define ELFIN_EINT0_BASE    0x7f008900
#define ELFIN_EINT0_BASE    0x7f008900
#define ELFIN_EINTSRV_BASE  0x7f008280
...
static inline S3C64XX_INTERRUPT * S3C64XX_GetBase_INTC0(void)
{
    return (S3C64XX_INTERRUPT *)ELFIN_VIC0_BASE;
}

static inline S3C64XX_INTERRUPT * S3C64XX_GetBase_INTC1(void)
{
    return (S3C64XX_INTERRUPT *)ELFIN_VIC1_BASE;
}

static inline S3C64XX_GPA * S3C64XX_GetBase_GPA (void)
{
    return (S3C64XX_GPA *)ELFIN_GPA_BASE;
}

static inline S3C64XX_GPB * S3C64XX_GetBase_GPB (void)
{
    return (S3C64XX_GPB *)ELFIN_GPB_BASE;
}

static inline S3C64XX_GPC * S3C64XX_GetBase_GPC (void)
{
    return (S3C64XX_GPC *)ELFIN_GPC_BASE;
}

static inline S3C64XX_GPD * S3C64XX_GetBase_GPD (void)
{
    return (S3C64XX_GPD *)ELFIN_GPD_BASE;
}

static inline S3C64XX_GPE * S3C64XX_GetBase_GPE (void)
{
    return (S3C64XX_GPE *)ELFIN_GPE_BASE;
}

static inline S3C64XX_GPF * S3C64XX_GetBase_GPF (void)
{
    return (S3C64XX_GPF *)ELFIN_GPF_BASE;
}

static inline S3C64XX_GPG * S3C64XX_GetBase_GPG (void)
{
    return (S3C64XX_GPG *)ELFIN_GPG_BASE;
}

static inline S3C64XX_GPH * S3C64XX_GetBase_GPH (void)
{
    return (S3C64XX_GPH *)ELFIN_GPH_BASE;
}

static inline S3C64XX_GPI * S3C64XX_GetBase_GPI (void)
{
    return (S3C64XX_GPI *)ELFIN_GPI_BASE;
}

static inline S3C64XX_GPJ * S3C64XX_GetBase_GPJ (void)
{
    return (S3C64XX_GPJ *)ELFIN_GPJ_BASE;
}

static inline S3C64XX_GPK * S3C64XX_GetBase_GPK (void)
{
    return (S3C64XX_GPK *)ELFIN_GPK_BASE;
}

static inline S3C64XX_GPL * S3C64XX_GetBase_GPL (void)
{
    return (S3C64XX_GPL *)ELFIN_GPL_BASE;
}

static inline S3C64XX_GPM * S3C64XX_GetBase_GPM (void)
{
    return (S3C64XX_GPM *)ELFIN_GPM_BASE;
}

static inline S3C64XX_GPN * S3C64XX_GetBase_GPN (void)
{
    return (S3C64XX_GPN *)ELFIN_GPN_BASE;
}

static inline S3C64XX_EINT0 * S3C64XX_GetBase_EINT0 (void)
{
    return (S3C64XX_EINT0 *)ELFIN_EINT0_BASE;
}

static inline S3C64XX_EINTSRV * S3C64XX_GetBase_EINTSRV (void)
{
    return (S3C64XX_EINTSRV *)ELFIN_EINTSRV_BASE;
}

static inline S3C64XX_GPO * S3C64XX_GetBase_GPO (void)
{
    return (S3C64XX_GPO *)ELFIN_GPO_BASE;
}

static inline S3C64XX_GPP * S3C64XX_GetBase_GPP (void)
{
    return (S3C64XX_GPP *)ELFIN_GPP_BASE;
}

static inline S3C64XX_GPQ * S3C64XX_GetBase_GPQ (void)
{
    return (S3C64XX_GPQ *)ELFIN_GPQ_BASE;
}
